...
abstract class AppColors {
  ...
  static const Color darkBlue = Color(0xFF064061,); // الكحلي العميق (للنصوص الأساسية)
  ...
  static const Color coralOrange = Color(0xFFF3735E,); // برتقالي مرجاني (تنبيه أو حذف)
  static const Color sandBeige = Color(0xFFE2DECD); // بيج رملي

  // درجات الأبيض والرمادي (Backgrounds & Borders)
  static const Color pureWhite = Color(0xFFFFFFFF);
  static const Color backgroundWhite = Color(0xFFF7F9FA,); // خلفية التطبيق الهادئة
  ...
  static const Color smoothGreen = Color(0xFF396B5F);
  static const Color smoothWhite = Color(0xFFE7E7E7);
